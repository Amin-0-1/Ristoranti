...
extension UIView {
    ...
    @IBInspectable var UIShadowOpacity: Float {
        get {
    ...
    @IBInspectable var UIShadowRadius: CGFloat {
        get {
    ...
    @IBInspectable var UIShadowOffset: CGSize{
        get{
    ...
    @IBInspectable var UIShadowColor: UIColor? {
        get {
